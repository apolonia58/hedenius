...
public class Hauptfenster8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ////////////////////////////////////////////////////////////////////////////////
        Log.v("SPIEL RUNDE 8", "WECHSEL in Hauptfenster6 Aktivity.");
        ///////////////////////////////////////////////////////////////////////////////
        ...
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
                setContentView(R.layout.activity_hauptfenster8);
            }
        ...
        Log.v("Spiel Runde 8", "Apo ich bin in Runde 8");
    ...
    private void updateImage(){
        ...
        Log.v("MODUSWAHL", "zeitElement im Moduswahl ?"
                + zeitElement);*/
        Log.v("SPIEL RUNDE8", "img_view != nulL? " + (img_view != null));
        Log.v("SPIEL RUNDE8", "Bilder.images5[imagesNumber]  " + (Bilder.images8[imgNumber] ));
        /////////////////////////////////////////////////////////////////////////////////////
        img_view.setImageResource(Bilder.images8[imgNumber]);
    ...
    private void prepareGame() {
        ...
        Log.v("SPIEL RUNDE8", "img_view found?"
                + (img_view != null));
        ...
        btn_ja.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (imgNumber == Bilder.images8.length) {
                    Intent intent = new Intent(Hauptfenster8.this, Ende.class);
    ...
    public void SaveTimeInCsv (long reactionTime, boolean selectAnswer){
        itemNumber++;
        answerNumber++;
        correctAnswer = Bilder.answers8[answerNumber];
