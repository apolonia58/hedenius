...
public class Hauptfenster6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
                setContentView(R.layout.activity_hauptfenster6);
            }
        ...
        Log.v("Spiel Runde 6", "Apo ich bin in Runde 6");
    ...
    private void updateImage(){
        ...
        Log.v("MODUSWAHL", "zeitElement im Moduswahl ?"
                + zeitElement);*/
        Log.v("SPIEL RUNDE6", "img_view != nulL? " + (img_view != null));
        Log.v("SPIEL RUNDE6", "Bilder.images5[imagesNumber]  " + (Bilder.images6[imgNumber] ));
        /////////////////////////////////////////////////////////////////////////////////////
        img_view.setImageResource(Bilder.images6[imgNumber]);
    ...
    private void prepareGame() {
        ...
        btn_ja.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (imgNumber == Bilder.images6.length) {
                    Intent intent = new Intent(Hauptfenster6.this, Hauptfenster7.class);
    ...
    public void SaveTimeInCsv (long reactionTime, boolean selectAnswer){
        itemNumber++;
        answerNumber++;
        correctAnswer = Bilder.answers6[answerNumber];
