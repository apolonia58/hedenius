...
public class Hauptfenster2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ////////////////////////////////////////////////////////////////////////////////
        Log.v("RUNDE 2", "WECHSEL in Hauptfenster 2 Aktivity.");
        ///////////////////////////////////////////////////////////////////////////////
        ...
        Log.v("SPIEL RUNDE2 XXXXXXXXX", "Apo ich bin in Runde 2");
        Log.v("SPIEL RUNDE2 XXXXXXXXX", " "+ zeitFixkreuz +" ");
        Log.v("SPIEL RUNDE2 XXXXXXXXX", " "+ zeitOriginal +" ");
        Log.v("SPIEL RUNDE2 XXXXXXXXX", " "+ zeitGrau +" ");

        Handler handler = new Handler();
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
                setContentView(R.layout.activity_hauptfenster2);
            }
        ...
        Log.v("SPIEL RUNDE2", "Apo ich bin in Runde 2");
    ...
    private void updateImage(){
        ...
        /*Log.v("MODUSWAHL", "zeitFixkreuz im Moduswahl ?"
                + zeitFix);*/
        Log.v("SPIEL RUNDE2", "img_view != nulL? " + (img_view != null));
        Log.v("SPIEL RUNDE2", "Bilder.images2[imagesNumber]  " + (Bilder.images2[imgNumber] ));
        /////////////////////////////////////////////////////////////////////////////////////
    ...
    private void prepareGame() {
        ...
        Log.v("SPIEL RUNDE2", "img_view found?"
                + (img_view != null));
    ...
    public void SaveTimeInCsv (long reactionTime, boolean selectAnswer){
        itemNumber++;
        answerNumber++;
        correctAnswer = Bilder.answers2[answerNumber];
