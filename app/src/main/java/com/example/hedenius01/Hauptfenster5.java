...
public class Hauptfenster5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
                setContentView(R.layout.activity_hauptfenster5);
            }
        ...
        Log.v("Spiel Runde 5", "Apo ich bin in Runde 5");
    ...
    private void updateImage(){
        ...
        Log.v("MODUSWAHL", "zeitElement im Moduswahl ?"
                + zeitElement);*/
        Log.v("SPIEL RUNDE5", "img_view != nulL? " + (img_view != null));
        Log.v("SPIEL RUNDE5", "Bilder.images5[imagesNumber]  " + (Bilder.images5[imgNumber] ));
        /////////////////////////////////////////////////////////////////////////////////////
        img_view.setImageResource(Bilder.images5[imgNumber]);
    ...
    private void prepareGame() {
        ...
        Log.v("SPIEL RUNDE5", "img_view found?"
                + (img_view != null));
        ...
        btn_ja.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(getApplicationContext(), "benötigte Zeit in ms:  " + zeit,Toast.LENGTH_SHORT).show();
                    ...
                    if (imgNumber == Bilder.images5.length) {
                        Intent intent = new Intent(Hauptfenster5.this, Hauptfenster6.class);
    ...
    public void SaveTimeInCsv (long reactionTime, boolean selectAnswer){
        itemNumber++;
        answerNumber++;
        correctAnswer = Bilder.answers5[answerNumber];
