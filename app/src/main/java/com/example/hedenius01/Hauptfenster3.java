...
public class Hauptfenster3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ////////////////////////////////////////////////////////////////////////////////
        Log.v("SPIEL RUNDE 3", "WECHSEL in Hauptfenster3 Aktivity.");
        ///////////////////////////////////////////////////////////////////////////////
        ...
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
                setContentView(R.layout.activity_hauptfenster3);
            }
        ...
        Log.v("Spiel Runde 3", "Apo ich bin in Runde 3");
    ...
    private void updateImage(){
       ...
       /* Log.v("MODUSWAHL", "zeitElement im Moduswahl ?"
                + zeitElement);*/
        Log.v("SPIEL RUNDE3", "img_view != nulL? " + (img_view != null));
        Log.v("SPIEL RUNDE3", "Bilder.images3[imagesNumber]  " + (Bilder.images3[imgNumber] ));
        /////////////////////////////////////////////////////////////////////////////////////
        img_view.setImageResource(Bilder.images3[imgNumber]);
...
*/
    ...
    private void prepareGame() {
        ...
        Log.v("SPIEL RUNDE3", "img_view found?"
                + (img_view != null));
        ...
        btn_ja.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(getApplicationContext(), "benötigte Zeit in ms:  " + zeit,Toast.LENGTH_LONG).show();

                    if (imgNumber == Bilder.images3.length) {
                        Intent intent = new Intent(Hauptfenster3.this, Hauptfenster4.class);
    ...
    public void SaveTimeInCsv (long reactionTime, boolean selectAnswer){
        itemNumber++;
        answerNumber++;
        correctAnswer = Bilder.answers3[answerNumber];
