 ...
 */
//In dieser Klasse werden alle Images in einem Array gespeichert.
//Für jede Runde gibt es einen eigenen Array.
//Von hier aus werden die einzelnen Bilder in den ImageViews gealden.
...
public class Bilder {
    ...
    //TRAINING MODUS BILDER
    //Training Runde 1
    //reale Elemente mit Hintergrund
    public static int[] training1images = new int []{
            R.drawable.not_training1img1, R.drawable.set_training1img1,
            R.drawable.not_training1img2, R.drawable.set_training1img2
    };

    //Training Runde 2
    //fiktive Elemente ohne Hintergrund
    public static int[] training2images = new int []{
           R.drawable.set_training2img1 ,R.drawable.not_training2img1,
            R.drawable.not_training2img2, R.drawable.set_training2img2
    };

    //In diesen arrays werden die richtigen Antworten gespeichert.
    // In den jeweiligen Runden werden diese in die CSV geschrieben.
    // Am Ende werden die eigene Antworten mit diesen verglichen und in der CSV ausgewertet.
    //Antworten zu Runde1 reale Elemente mit Hintergrund
    // 1 0 0 1 1 0 0 1
    public static boolean[] answers = new boolean[] {
            true, false, false, true , true , false, false, true
    };

    //Antworten zu Runde2 reale Elemente mit Hintergrund
    // 0 0 1 1 0 0  1 1
    public static boolean[] answers2 = new boolean[] {
            false, false, true, true, false, false, true, true
    };

    //Antworten zu Runde3 reale Elemente mit Hintergrund
    // 0 1 0 1 0 0 1 1
    public static boolean[] answers3 = new boolean[] {
            false, true, false, true, false, false, true, true
    };

    //Antworten zu Runde4 reale Elemente mit Hintergrund
    // 1 1 0 1 0 1 0 0
    public static boolean[] answers4 = new boolean[] {
            true, true, false, true, false, true, false, false
    };

    //Antworten zu Runde5 fiktive Elemente ohne Hintergrund
    // 0 1 1 0 0 1 0 1
    public static boolean[] answers5 = new boolean[] {
            false, true, true, false, false, true, false, true
    };

    //Antworten zu Runde6 fiktive Elemente ohne Hintergrund
    // 1 0 1 0 1 0 1 0
    public static boolean[] answers6 = new boolean[] {
            true, false, true, false, true, false, true, false
    };

    //Antworten zu Runde7 fiktive Elemente ohne Hintergrund
    // 0 0 1 0 1 1 0 1
    public static boolean[] answers7 = new boolean[] {
            false, false, true, false, true, true,  false, true
    };

    //Antworten zu Runde8 fiktive Elemente ohne Hintergrund
    // 1 0 0 1 0 0 1 1
    public static boolean[] answers8 = new boolean[] {
            true, false, false, true, false, false, true, true
    };

    // Antworten für den TRAININGS MODUS
    //Antworten zu SetTraining Runde1 reale Elemente mit Hintergrund
    // 0 1 0 1
    public static boolean[] training1answers = new boolean[] {
            false, true, false, true
    };

    //Antworten zu SetTraining Runde2 fiktive Elemente ohne Hintergrund
    // 1 0 0 1
