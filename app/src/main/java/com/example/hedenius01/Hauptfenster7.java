...
public class Hauptfenster7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ////////////////////////////////////////////////////////////////////////////////
        Log.v("SPIEL RUNDE 6", "WECHSEL in Hauptfenster6 Aktivity.");
        ///////////////////////////////////////////////////////////////////////////////
        ...
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
                setContentView(R.layout.activity_hauptfenster7);
            }
        ...
        Log.v("Spiel Runde 6", "Apo ich bin in Runde 7");
    ...
    private void updateImage(){
        ...
        Log.v("MODUSWAHL", "zeitElement im Moduswahl ?"
                + zeitElement);*/
        Log.v("SPIEL RUNDE7", "img_view != nulL? " + (img_view != null));
        Log.v("SPIEL RUNDE7", "Bilder.images5[imagesNumber]  " + (Bilder.images7[imgNumber] ));
        /////////////////////////////////////////////////////////////////////////////////////
        img_view.setImageResource(Bilder.images7[imgNumber]);
    ...
    private void prepareGame() {
        ...
        Log.v("SPIEL RUNDE7", "img_view found?"
                + (img_view != null));
        ...
        btn_ja.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (imgNumber == Bilder.images7.length) {
                    Intent intent = new Intent(Hauptfenster7.this, Hauptfenster8.class);
    ...
    public void SaveTimeInCsv (long reactionTime, boolean selectAnswer){
        itemNumber++;
        answerNumber++;
        correctAnswer = Bilder.answers7[answerNumber];
